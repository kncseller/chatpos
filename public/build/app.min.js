...
(function(win){
    ...
    win.u = {
        ...
        ping : function(f){
            post("api/user.php?ac=ping",{},function(r){ 
                if(f)f(r);
            });
           return this;
        },
        ...
        mine : function(f){
            post("api/user.php?ac=mine",{},function(r){
                if(r.code){
                    var data = r.data;
                    u.mine = data;
...
var appconfig={
    upload:"https://faucet.donggiatri.com/modules/chat.donggiatri.com/upload.php" 
};
